...
SELECT * FROM student WHERE major='英語' ORDER BY score DESC LIMIT 1;

SELECT * FROM student WHERE major='英語' AND score < 60;

SELECT * FROM student WHERE major='英語' OR score > 60;
